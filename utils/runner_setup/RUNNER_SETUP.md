...
> https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/settings/actions/runners

Or via the `gh` CLI / REST API:

```bash
gh api repos/SemiAnalysisAI/InferenceX-Private-TPU/actions/runners \
...
2. Clone InferenceX (or just copy the two scripts in this directory onto the host):
   ...
   ```bash
   git clone https://github.com/SemiAnalysisAI/InferenceX-Private-TPU.git
   ```

3. Navigate to
   [github.com/SemiAnalysisAI/InferenceX-Private-TPU/settings/actions/runners/new?arch=x64&os=linux](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/settings/actions/runners/new?arch=x64&os=linux)
...
6. Verify the runners show up as **Idle** on the
   [runners settings page](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/settings/actions/runners),
