...
一键触发的 [`speedbench-al.yml`](../.github/workflows/speedbench-al.yml) 工作流最初由 [InferenceX#1650](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1650) 引入，随后在 [InferenceX#1706](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1706) 中扩展到更多 MTP 和 EAGLE3 模型。它取代了 [InferenceX#1592](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1592) 中早期手工整理的参考值，使精确命令、日志、输出和生成的 YAML 都可以从同一次运行中审计。其流程如下：
...
- [AMD @haic0 的类似工作：PR 参考 1](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1633)
- [AMD @haic0 的类似工作：参考 2](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1115#issuecomment-4295024377)
...
- [InferenceX 合成接受跟踪 issue](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/issues/1651)
- [InferenceX SPEED-Bench 工作流](../.github/workflows/speedbench-al.yml)
- [InferenceX 早期参考值对齐 PR](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1592)
- [InferenceX 初始 AL 收集器 PR](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1650)
- [InferenceX 多模型 AL 收集器 PR](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1706)
- [InferenceX 多节点合成接受验证](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1789)
