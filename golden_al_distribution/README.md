...
The push-button [`speedbench-al.yml`](../.github/workflows/speedbench-al.yml) workflow, introduced in [InferenceX#1650](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1650) and extended to additional MTP and EAGLE3 models in [InferenceX#1706](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1706), performs the following process. It superseded the early manually assembled reference in [InferenceX#1592](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1592), making the exact commands, logs, outputs, and generated YAML auditable from one run.
...
gh workflow run speedbench-al.yml \
  --repo SemiAnalysisAI/InferenceX-Private-TPU \
  --ref BRANCH \
  -f runner=b300 \
  -f model=HF_MODEL_ID \
...
| --- | --- | --- | --- |
| DeepSeek V4 Pro | MTP | [`dsv4_mtp.yaml`](dsv4_mtp.yaml) | [27180633016](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/actions/runs/27180633016) |
| Qwen3.5 397B-A17B | MTP | [`qwen3.5_mtp.yaml`](qwen3.5_mtp.yaml) | [27317114007](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/actions/runs/27317114007) |
| Kimi K2.5 | EAGLE3 | [`kimik2.5_eagle3.yaml`](kimik2.5_eagle3.yaml) | [28122195822](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/actions/runs/28122195822) |
| MiniMax-M3 | EAGLE3 | [`minimaxm3_eagle3.yaml`](minimaxm3_eagle3.yaml) | [28061204145](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/actions/runs/28061204145) |

## Primary references

- [Similar Efforts from AMD @haic0 PR Reference 1](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1633)
- [Similar Efforts from AMD @haic0 Reference 2](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1115#issuecomment-4295024377)
...
- [InferenceX synthetic-acceptance tracking issue](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/issues/1651)
- [InferenceX SPEED-Bench workflow](../.github/workflows/speedbench-al.yml)
- [InferenceX early reference-alignment PR](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1592)
- [InferenceX initial AL collector PR](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1650)
- [InferenceX multi-model AL collectors PR](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1706)
- [InferenceX multi-node synthetic-acceptance bring-up](https://github.com/SemiAnalysisAI/InferenceX-Private-TPU/pull/1789)
